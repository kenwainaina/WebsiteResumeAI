...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-purple-950 via-red-950 to-purple-950 pt-16">
      <Navbar />
            ...
            <Card className="bg-white/5 border-white/10">
              <CardContent className="p-6">
                <p className="text-gray-300 leading-relaxed">
                  ...
                  robust background in data analytics, generative AI, and software development. Proficient in SQL,
                  Python, Java, CSS, and HTML. Experienced in building and maintaining personal websites, utilizing
                  Microsoft tools, and database systems. I also have a basic knowledge of cybersecurity and privacy
                  controls and regulations (e.g., NIST, FISMA, FISCAM) and am eager to learn more about these areas.
                  Adept at project management and team collaboration, with a strong focus on delivering efficient IT
                  solutions.
                </p>
              </CardContent>
            </Card>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card className="bg-white/5 border-white/10 hover:bg-white/10 transition-colors">
                <CardContent className="p-6">
                  ...
                  <ul className="space-y-2 text-gray-300">
                    ...
                    <li>
                      • Created and scheduled social media announcements to promote Chamber events and initiatives
                    </li>
                    <li>
              ...
              <Card className="bg-white/5 border-white/10 hover:bg-white/10 transition-colors">
                <CardContent className="p-6">
                  ...
                  <ul className="space-y-2 text-gray-300">
                    <li>
                      • Advanced from Cashier to manager in two years, leading and optimizing a team of 7 cashiers
                    </li>
